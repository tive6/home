(function ($) {
  ...
  HL.firmService = {
     ...
     * actionCode : H458001
     */
    getDemandsList: function (opts, succCallback, errCallback) {
      var url = config.SERVICE_URL + config.SERVICE_URI_MAP.SELECT_DEMAND_LIST;
      doFetch(url, opts, succCallback, errCallback, 'H458001');
    }
  };
  /**
   * 发起请求
