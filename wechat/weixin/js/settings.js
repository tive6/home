(function(factory) {
  ...
  var config = {
    ...
    BASE_URL: 'http://192.168.1.187:8082',
    SERVICE_URL: 'http://192.168.1.187:8082',

    // BASE_URL: 'http://192.168.12.106',
    // SERVICE_URL: 'http://192.168.12.106',
    // BASE_URL: 'http://192.168.12.106',
    // SERVICE_URL: 'http://192.168.12.106',
    // 后台返回静态资源域(最后 '/' 不可缺少)
    ...
    SERVICE_URI_MAP: {
      ...
      //scope为snsapi_base
      WECHAT_SNSAPI_BASE: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx520c15f417810387&redirect_uri=https%3A%2F%2Fchong.qq.com%2Fphp%2Findex.php%3Fd%3D%26c%3DwxAdapter%26m%3DmobileDeal%26showwxpaytitle%3D1%26vb2ctag%3D4_2030_5_1194_60&response_type=code&scope=snsapi_base&state=123#wechat_redirect',
      // scope为snsapi_userinfo
      WECHAT_SNSAPI_USERINFO: 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf0e81c3bee622d60&redirect_uri=http%3A%2F%2Fnba.bluewebgame.com%2Foauth_response.php&response_type=code & scope = snsapi_userinfo & state = STATE# wechat_redirect',
      // 通过code换取网页授权access_token
      WECHAT_ACCESS_TOKEN: 'https://api.weixin.qq.com/sns/oauth2/access_token?appid=APPID&secret=SECRET&code=CODE&grant_type=authorization_code',
      //刷新access_token（如果需要）
      WECHAT_REFRESH_ACCESS_TOKEN: 'https://api.weixin.qq.com/sns/oauth2/refresh_token?appid=APPID&grant_type=refresh_token&refresh_token=REFRESH_TOKEN',
      //拉取用户信息(需scope为 snsapi_userinfo)
      WECHAT_GET_USERINFO: 'https://api.weixin.qq.com/sns/userinfo?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN',
      //检验授权凭证（access_token）是否有效
      WECHAT_AUTH_ACCESS_TOKEN: 'https://api.weixin.qq.com/sns/auth?access_token=ACCESS_TOKEN&openid=OPENID',
      ...
      ISHADPAYPWD: '/api/appUser/isHadPaypwd.json', // 添加支付密码
      ADDPAYPWD: '/api/appUser/addPayPwd.json', // 添加支付密码
      VERIFYPAYPWD: '/api/appUser/verifyPaypwd.json', // 验证原始支付密码
      CHANGEPAYPWDOLD: '/api/appUser/changePayPwdOld.json', // 根据旧密码修改支付密码
      AUTHENTICATION: '/api/appUser/authentication.json', // 身份验证
      CHANGEPAYPWD: '/api/appUser/changePayPwd.json', // 修改支付密码
      CHANGEPAYPWDBYAUTH: '/api/appUser/changePayPwdByAuth.json', // 修改支付密码
      CHECKCODE4CHECKEQUIPMENT: '/api/other/checkCode4checkEquipment.json', // 身份认证验证码
